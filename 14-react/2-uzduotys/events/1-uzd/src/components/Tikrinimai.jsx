const Tikrinimai = () => {
    ...
    const yraLyginis = () => {
        skaicius % 2 === 0 ? alert(`Skaicius ${skaicius} - Lyginis good job`) : alert(`Skaicius ${skaicius} - nelyginis sad life`)
    }
    const arDidenisNei30 = () => { 
        skaicius > 30 ? alert(`Skaicius ${skaicius} - Didesnis uz 30`) : alert(`Skaicius ${skaicius} - mazesnis uz 30 sad life`)
    }
    ...
    return (
        <div>
            ...
            <button onClick={arDidenisNei30}>Tikrinam skaiciuka ar didesnis nei 30</button>
