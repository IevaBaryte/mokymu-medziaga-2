...
const MedzioApdirbejas = () => {
  ...
  return (
    <div>
      ...
      <input type="number" id="medziagos" ref={medziagosRef} placeholder="Medziagu kaina"/>

      <input type="number" id="valandos" ref={valandosRef} placeholder="Dirbtos valandos"/>

      <input type="number" id="uzdarbis" ref={uzdarbisRef} placeholder="Valandinis uzdarbis"/>
